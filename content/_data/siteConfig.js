...
module.exports = {
  ...
  site: {
    title: 'Burton 5',
    description: 'MIT Burton 5 website',
    url: process.env.URL || 'https://burton5.netlify.app/',
  ...
  metaPages: [
    ...
    {
      url: 'https://mit.edu/accessibility/',
      title: 'Accessibility',
    },
    {
      url: 'https://studentlife.mit.edu/support',
